...
export default function Dashboard() {
  ...
  const handleDelete = (id: number) => {
    ...
    const updatedSubmittedUsers = submittedUsers.filter((u: User) => u.id !== id);
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link href="/dashboard-add" passHref>
            <span className="bg-blue-600 hover:bg-blue-700 transition text-white px-6 py-2 rounded-lg font-semibold shadow inline-flex items-center">
